...
"""
import unittest
from src.ranking_metrics import RankingMetrics, Bm25
...
class TestFDARO(unittest.TestCase):
    ...
    def test_update_case_2(self):
        ...
        self.assertEqual(metric.metrics[f"Bm25_{metric.name()}"], 2)
