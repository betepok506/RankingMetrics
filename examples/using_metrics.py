import importlib
import docs_ranking_metrics
importlib.reload(docs_ranking_metrics.ranking_metrics)

from docs_ranking_metrics.ranking_metrics import (
    RankingMetrics,
    Bm25,
    LaBSE,
    MsMarcoST,
...
data = [{"query": ")what was the immediate impact of the success of the manhattan project?",
       ...
       {"query": "what is rba",
        ...
        'is_selected': [1, 1, 1, -1, 1, 1],
       }]

if __name__ == "__main__":
    # Объявление метрик
    metrics = [LaBSE(), Bm25()]#, MsMarcoCE(), MsMarcoST(), ]
